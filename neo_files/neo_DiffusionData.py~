...
def Generate_DiffusionData(writeTo,LabelCSV):
	...
	all_files = []
	Join_files=['./neo_files/neo_df_fa.csv',LabelCSV]

	rest_files = ['./neo_files/neo_df_ad.csv','./neo_files/neo_df_rd.csv','./neo_files/neo_df_md.csv']
	...
	Brain_Info = pd.read_csv('./neo_files/neo_df_fa.csv')
	...
	for dwi_file in rest_files:
		...
		if dwi_file=='./neo_files/neo_df_ad.csv':
			Brain_Info=change_col_name(Brain_Info,'AD_')
		if dwi_file=='./neo_files/neo_df_rd.csv':
			Brain_Info=change_col_name(Brain_Info,'RD_')
		if dwi_file=='./neo_files/neo_df_md.csv':
	...
	Brain_cog.to_csv('./neo_files/neo_Fiber%s.csv' %writeTo,index=False)
	...
	FibEnigma.to_csv('./neo_files/neo_FiberEnigma%s.csv' %writeTo,index=False)
