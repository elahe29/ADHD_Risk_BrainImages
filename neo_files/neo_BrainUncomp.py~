...
def Generate_BrainUncomp(writeTo,Brain_cog,B):
	...
	print "Merge of Labels and neo_HippoAmy.csv",Brain_cog.shape
...
Brain_cog = pd.read_csv('./neo_files/neo_HippoAmy.csv')
...
Generate_BrainUncomp('./neo_files/neo_BrainUncomp.csv',Brain_cog,B)

B = pd.read_csv('LABELS_balanced.csv')
Generate_BrainUncomp('./neo_files/neo_BrainUncomp_balanced.csv',Brain_cog,B)
