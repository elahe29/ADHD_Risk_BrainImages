...
Brain_cog = pd.read_csv('./1year_files/1year_subcortical.csv')
...
Generate_BrainUncomp('./1year_files/1year_BrainUncomp.csv',Brain_cog,B)

B = pd.read_csv('LABELS_balanced.csv')
Generate_BrainUncomp('./1year_files/1year_BrainUncomp_balanced.csv',Brain_cog,B)
