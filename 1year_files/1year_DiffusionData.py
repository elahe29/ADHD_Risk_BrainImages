...
def Generate_DiffusionData(writeTo,LabelCSV):
	all_files = []
	Join_files=['./1year_files/1year_df_fa.csv','LABELS.csv']
	...
	Brain_cog.to_csv('./1year_files/1year_Fiber%s.csv' %writeTo,index=False)

	Enigma = pd.read_csv('./1year_files/1year_Enigma.csv')
	...
	FibEnigma.to_csv('./1year_files/1year_FiberEnigma%s.csv' %writeTo,index=False)
