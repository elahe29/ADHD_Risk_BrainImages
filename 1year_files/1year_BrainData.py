...
all_files = []
Join_files=['./1year_files/1year_subcortical.csv']
...
BrainData=pd.read_csv('./1year_files/1year_subcortical.csv')
UnBrainData=pd.read_csv('./1year_files/1year_subcortical.csv')
print 'Shape of 1year_subcortical.csv:',BrainData.shape
...
BrainData.to_csv('./1year_files/1year_BrainData.csv',index=False)
UnBrainData.to_csv('./1year_files/1year_UnBrainData.csv',index=False)
