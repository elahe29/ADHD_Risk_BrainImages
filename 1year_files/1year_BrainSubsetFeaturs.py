...
def Generate_BrainCogData(BrainCog,BrainData,writeTo):
	...
	BrainSubsetFeats.to_csv('./1year_files/1year_BrainSubsetFeats%s.csv' %writeTo,index=False)
	...
	BrainSubsetFeats = BrainSubsetFeats[new_orderCols]
	BrainSubsetFeats.to_csv('./1year_files/1year_NoLabelBrainSubsetFeats%s.csv' %writeTo,index=False)

BrainCog = pd.read_csv('./1year_files/1year_BrainUncomp.csv')
BrainData = pd.read_csv('./1year_files/1year_UnBrainData.csv') 
Generate_BrainCogData(BrainCog,BrainData,'')

BrainCog = pd.read_csv('./1year_files/1year_BrainUncomp_balanced.csv')
