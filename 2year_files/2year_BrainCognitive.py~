...
def Generate_BrainCognitive(writeTo,B):
	Brain_Info = pd.read_csv('./2year_files/2year_subcortical.csv')
...
Generate_BrainCognitive('./2year_files/2year_Brain_cog.csv',B)

B = pd.read_csv('LABELS_balanced.csv')
Generate_BrainCognitive('./2year_files/2year_Brain_cog_balanced.csv',B)
