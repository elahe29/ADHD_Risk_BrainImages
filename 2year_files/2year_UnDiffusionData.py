...
all_files = []
Join_files=['./2year_files/2year_df_fa.csv']
...
Brain_cog.to_csv('./2year_files/2year_UnFiber.csv',index=False)
...
FibEnigma.to_csv('./2year_files/2year_UnFiberEnigma.csv',index=False)
