...
def Generate_BrainCogData(BrainCog,BrainData,writeTo):
	BrainCog = pd.read_csv('./2year_files/2year_BrainUncomp.csv')
	BrainData = pd.read_csv('./2year_files/2year_UnBrainData.csv') 
	...
	BrainSubsetFeats.to_csv('./2year_files/2year_BrainSubsetFeats%s.csv' %writeTo,index=False)
	...
	BrainSubsetFeats = BrainSubsetFeats[new_orderCols]
	BrainSubsetFeats.to_csv('./2year_files/2year_NoLabelBrainSubsetFeats%s.csv' %writeTo,index=False)

BrainCog = pd.read_csv('./2year_files/2year_BrainUncomp.csv')
BrainData = pd.read_csv('./2year_files/2year_UnBrainData.csv') 
Generate_BrainCogData(BrainCog,BrainData,'')

BrainCog = pd.read_csv('./2year_files/2year_BrainUncomp_balanced.csv')
